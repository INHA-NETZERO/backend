...
**성공:**
```json
{ "success": true, "data": { /* 엔드포인트별 payload */ } }
```
**오류:**
```json
...
하루치 판매를 담은 CSV(날씨 컬럼 없음). **행사/신메뉴/비고_시나리오는 품목(행)별로** CSV 컬럼에 담는다(그날 전체 일괄 적용 아님).
...
```json
{ "success": false, "error": { "code": "INVALID_CSV", "message": "CSV 헤더가 올바르지 않습니다." } }
```
...
```
> 폐기_kg·탄소_kgCO2e·폐기_비용_원은 적재 시 ItemMaster로 계산되어 저장(backend_spec §3.2).
...
```json
{ "success": true,
  "data": { "region": "서울_강남", "forecastDate": "2026-06-28",
    "avgTemp": 21.2, "precipitationMm": 12.0, "precipitationProb": 80, "skyCode": 4 } }
```
...
{ "success": true,
  "data": {
    ...
    "skipped": [
      { "itemId": 205, "itemName": "원두", "reason": "NOT_DUE",
        "daysSinceLastOrder": 3, "orderCycleDays": 14 }
    ] } }
```
...
{ "success": true,
  "data": { "items": [
    { "itemId": 101, "itemName": "우유", "unit": "L",
      "coverage": { "leadTimeDays": 1, "orderCycleDays": 7, "coverageDays": 8 },
      "horizonForecast": { "p10": 60, "p50": 80, "p90": 108 },
      "recommendedQuantity": 66, "actualQuantity": 60, "optimalStockQuantity": 76.1, "onHand": 12,
...
```json
{ "storeId": 1, "targetDate": "2026-06-27",
  "items": [ { "itemId": 101, "actualQuantity": 60 },
...
```json
{ "success": true,
  "data": { "storeId": 1, "targetDate": "2026-06-27", "updated": 2, "notFound": [],
    "items": [
      { "itemId": 101, "itemName": "우유", "recommendedQuantity": 66, "actualQuantity": 60 },
      { "itemId": 205, "itemName": "원두", "recommendedQuantity": 12, "actualQuantity": 0 } ] } }
```
...
{ "success": true,
  "data": { "storeId": 1, "targetDate": "2026-06-27",
    ...
    "byItem": [ { "itemId": 101, "itemName": "우유",
      "wasteAvoidedKg": 12.31, "guaranteedSavingKg": 2.46, "potentialSavingKg": 39.4 } ] } }
```
...
{ "success": true,
  "data": { "series": [
    { "date": "2026-06-25", "guaranteedSavingKg": 2.1, "potentialSavingKg": 33.0 },
    { "date": "2026-06-26", "guaranteedSavingKg": 2.4, "potentialSavingKg": 38.2 }
  ] } }
```
...
```json
{ "success": true,
  "data": { "totalGuaranteedKg": 64.2, "totalPotentialKg": 980.5,
    "carEquivalentKm": 213.2, "periodDays": 30 } }
```
...
{ "success": true,
  "data": {
    "today": { "targetDate": "2026-06-27", "dueItemCount": 5,
      "potentialSavingKg": 39.4, "guaranteedSavingKg": 2.46 },
    "orderGuide": [ { "itemId": 101, "itemName": "우유", "recommendedQuantity": 66, "unit": "L" } ],
...
{ "success": true,
  "data": { "count": 6, "items": [
    { "itemId": 101, "name": "우유", "category": "원재료", "wasteTarget": true,
      "unit": "L", "shelfLifeDays": 7, "storageCondition": "냉장",
      "kgPerUnit": 1.03, "efProd": 3.0, "efWaste": 0.2,
      "purchasePrice": 1000, "priceUnit": "원/L", "note": "EF: OWID/Poore2018 우유≈3" }
  ] } }
```
...
{ "success": true,
  "data": {
    "storeId": 1, "businessDate": "2026-06-27", "dayOfWeek": "토", "itemCount": 6,
    "summary": { "totalWasteKg": 3.21, "totalWasteCarbonKg": 9.84, "totalWasteCostKrw": 11950 },
    "items": [
      { "itemId": 101, "itemName": "우유", "category": "원재료", "unit": "L",
        "orderedQty": 0, "openingStock": 12, "demand": 9, "actualSales": 9, "stockout": 0,
        "wasteQty": 1, "closingStock": 2,
        "wasteKg": 1.03, "wasteCarbonKg": 3.296, "wasteCostKrw": 1000,
...
- 신규 `POST /ingest/sales/daily` (하루치 CSV; 행사/신메뉴/비고_시나리오는 품목별 CSV 컬럼, 날씨는 기상청 자동 보강).
